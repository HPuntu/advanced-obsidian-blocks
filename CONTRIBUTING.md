...
Contributions are welcome when they preserve Fenced Blocks' narrow product boundary: reusable visual `:::name` blocks with a low-friction Obsidian-native interface.
