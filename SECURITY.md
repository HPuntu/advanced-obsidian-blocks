...
Advanced Obsidian Blocks is offline-only. It makes no network requests, starts no processes, opens no sockets, uses no telemetry, and has no runtime package dependencies.
